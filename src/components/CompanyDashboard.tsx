...
//           const carbonData = {
//             totalOffset: json.data.simpleCard.total_carbon_offset.amount,
//             totalUptake: json.data.simpleCard.total_carbon_uptake.amount,
//             totalActiveProject: json.data.simpleCard.total_active_project.amount,
//             totalInvestment: json.data.simpleCard.total_investment.amount,
//             totalCertificate: json.data.simpleCard.total_certificate.amount,
//             totalProject: json.data.simpleCard.total_project.amount,
//             totalVerified: json.data.simpleCard.total_verified.amount
//           };

//           console.log(carbonData);
//           // kalau mau dipakai langsung di sini, tinggal gunakan carbonData
//         }
//       } catch (error) {
